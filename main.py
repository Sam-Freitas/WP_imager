...
if __name__ == "__main__":
    ...
    for this_plate_index in plate_index:
        ...
        movement.simple_stream.move_XY_at_Z_travel(this_plate_position,s_machines['grbl'][0],z_travel_height = s_machines['grbl'][2], testing=False, go_back_down = False, round_decimals = 4, camera=1)
        ...
        movement.simple_stream.move_XYZ(calibration_coordinates,s_machines['grbl'][0], testing=False, round_decimals = 4,camera=1)
        ...
        for well_index,this_terasaki_well_xy in enumerate(zip(s_terasaki_positions['x_relative_pos_mm'].values(),s_terasaki_positions['y_relative_pos_mm'].values())):
            ...
            movement.simple_stream.move_XYZ(terasaki_well_coords,s_machines['grbl'][0], testing=False, round_decimals = 4,camera=1)
            print('imaging')
